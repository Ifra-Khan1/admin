...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `role`(`Role_Name`) VALUES ('$a')";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Role Form </h3>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" name="rname" placeholder="Username">
                      </div>
